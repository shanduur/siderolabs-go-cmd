...
#
# Generated on 2026-07-03T09:10:57Z by kres d8aa28b.
...
RUN --mount=type=cache,target=/root/.cache/go-build,id=go-cmd/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=go-cmd/go/pkg go install github.com/shanduur/dis-vulncheck@${DIS_VULNCHECK_VERSION} \
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=go-cmd/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=go-cmd/go/pkg dis-vulncheck -tool=false ./...
